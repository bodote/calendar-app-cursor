...
public class ScheduleEventController {
        ...
        public String handleStep3Submit(
                ...
                List<PollData.EventTimeSlot> eventTimeSlots = step2Form.timeSlots().stream()
                                .filter(slot -> !slot.date().isEmpty() && !slot.startTime().isEmpty()
        ...
        @DeleteMapping("/event/{uuid}/participants/delete")
        public String deleteParticipant(
                ...
                List<PollData.Participant> updatedParticipants = existingPollData.participants().stream()
                                .filter(participant -> !participant.name().equals(participantName))
                                .toList();
